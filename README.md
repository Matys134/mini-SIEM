...
A distributed, microservices-based SIEM system designed to detect security incidents in real-time. The project demonstrates a robust Event-Driven Architecture deployed on Kubernetes, utilizing RabbitMQ for buffering, Redis for stateful analysis, and the ELK Stack for visualization.
...
⏳ Wait approx. 30-60 seconds for RabbitMQ, Redis, and Elastic to fully initialize.
...
Kibana (Logs & Visualizations): http://localhost:5601
